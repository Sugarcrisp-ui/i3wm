...
# Package categories
declare -A packages=(
    ["core"]="accountsservice aic94xx-firmware arandr archlinux-logout-git archlinux-keyring archlinux-tools archlinux-wallpaper baobab bash-completion betterlockscreen bibata-cursor-theme bitwarden bluetooth-autoconnect chaotic-keyring cmake copyq cppdap cronie dconf-editor downgrade fd edu-simplicity-theme-git feh ffmpeg font-manager geany gendesk git github-desktop gnome-boxes gnome-calculator gnome-disk-utility gparted gpick gufw hardinfo hblock hw-probe i3lock-color libwnck3 libreoffice-still lua51 meld meson micro mintstick ninja paprefs pinta polybar potrace powerline python python-cairo python-distro python-gobject python-psutil python-tqdm qbittorrent qt5-graphicaleffects qt5-quickcontrols qt5-quickcontrols2 qt5-svg qt5ct qt6ct rate-mirrors realvnc-vnc-server realvnc-vnc-viewer ripgrep rofi rsync seahorse sshfs sublime-text-4 timeshift unace unrar unzip virtualbox virtualbox-host-dkms linux-headers vlc xclip yay zip"
