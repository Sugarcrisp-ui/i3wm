...
# Package categories
declare -A packages=(
    ["core"]="accountsservice aic94xx-firmware arandr archlinux-keyring archlinux-tools archlinux-wallpaper baobab bash-completion betterlockscreen bibata-cursor-theme bitwarden bluetooth-autoconnect chaotic-keyring cmake copyq cppdap cronie dconf-editor downgrade fd feh ffmpeg font-manager geany gendesk git github-desktop gnome-boxes gnome-calculator gnome-disk-utility gparted gpick gufw hardinfo hblock hw-probe i3lock-color insync insync-thunar libwnck3 libreoffice-still lua51 meld meson micro mintstick ninja paprefs pinta polybar potrace powerline python python-cairo python-distro python-gobject python-psutil python-tqdm qbittorrent qt5-graphicaleffects qt5-quickcontrols qt5-quickcontrols2 qt5-svg qt5ct qt6ct rate-mirrors realvnc-vnc-server realvnc-vnc-viewer ripgrep rofi rsync seahorse sshfs sublime-text-4 timeshift unace unrar unzip vlc xclip yay zip"
