...
declare -A packages=(
    ...
    ["aur"]="arc-gtk-theme chili-sddm-theme joplin-appimage kvantum-theme-arc rofi-themes-collection-git sofirem-git pamac-aur ttf-vista-fonts ttf-font-awesome-5 sardi-icons elementary-icon-theme"
