...
rsync $RSYNC_OPTS /home/brett/.config/archlinux-betterlockscreen/ $DESTINATION/.config/archlinux-betterlockscreen > /home/brett/my-rsync-log-files/github/github.archlinux-betterlockscreen.log 2>&1 || echo "Error: rsync failed for archlinux-betterlockscreen"
...
rsync $RSYNC_OPTS /home/brett/.config/i3/config $DESTINATION/ > /home/brett/my-rsync-log-files/github/github.i3-config.log 2>&1 || echo "Error: rsync failed for i3-confg"
