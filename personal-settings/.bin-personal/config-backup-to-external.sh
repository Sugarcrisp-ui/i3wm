...
rsync $RSYNC_OPTS --exclude={Insync,autostart,facebookmessenger-nativefier-2f39e1,netflix-nativefier-7439ed,twitter-nativefier-a629d8,whatsapp-nativefier-d40211} /home/brett/.config/ $DESTINATION/.config
